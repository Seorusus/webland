...
function stability_preprocess_html(&$variables) {
  //drupal_add_css('//fonts.googleapis.com/css?family=Anton|Muli:300,400,400italic,300italic|Goudy+Bookletter+1911|Oswald&subset=cyrillic,latin,latin-ext', array('type' => 'external'));
  drupal_add_css('//fonts.googleapis.com/css?family=Oswald&subset=cyrillic,latin,latin-ext', array('type' => 'external'));
  drupal_add_css('//fonts.googleapis.com/css?family=Arizonia&amp;subset=latin-ext', array('type' => 'external'));
  drupal_add_css('//fonts.googleapis.com/css?family=Roboto&amp;subset=cyrillic', array('type' => 'external'));
...
function stability_process_html_tag(&$vars) {
  //$el = &$vars['element'];
