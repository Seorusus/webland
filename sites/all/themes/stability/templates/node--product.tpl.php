  ...
  <div class="col-md-6">
   ...
   <!-- <div class="review_num">
    ...
    <!--<div class="buttons_added">
	  ...
	  <a class="btn btn-primary form-submit" href="/placere-en-ordre">Placere en ordre</a>
    </div>
	<?php if ($content['field_template_link']): ?>
	<div class="buttons_added">
      <?php //print render($content['add_to_cart']); ?>
	  <a class="btn btn-primary form-submit" href="<?php print render($content['field_template_link']); ?>">Se skabeloner</a>
    </div>
    <?php endif; ?>-->
    ...
    <div class="product_meta">
      ...
      <span class="sku_wrapper">
        <?php //print strip_tags(render($content['list_price'])); ?>
      </span>
      <span class="sku_wrapper">
...
<h2 class="prodh2">Ordreformular</h2>
	<?php if ($content['field_template_link']): ?>
	<div class="buttons_added">
      <?php //print render($content['add_to_cart']); ?>
	  <a class="btn btn-primary form-submit" href="<?php print render($content['field_template_link']); ?>">Se skabeloner</a>
	...
	$block = module_invoke('webform', 'block_view', 'client-block-207');
